...
Seedable pseudo-random number generation for Mog. The canonical import is
`github.com/moglang/random`. This native package supports ABI 3 and Mog runtime
...
```bash
mog add github.com/moglang/random@v0.1.2
```
